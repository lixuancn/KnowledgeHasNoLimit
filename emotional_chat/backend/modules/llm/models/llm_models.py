...
class LLMProvider(str, Enum):
    ...
    """
    OPENAI = "openai"
    VOLCANO_ENGINE = "doubao-1-5-pro-32k-character-250715"
    ALIYUN_QWEN_MAX = "qwen-max"
...
class LLMConfig(BaseModel):
    """LLM配置模型"""
    provider: LLMProvider = Field(LLMProvider.ALIYUN_QWEN_MAX, description="默认提供商")
    ...
    class Config:
        json_schema_extra = {
            "example": {
                "provider": LLMProvider.ALIYUN_QWEN_MAX,
