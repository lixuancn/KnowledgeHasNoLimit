...
_default_db_url = (
    f"mysql+pymysql://{os.getenv('ALIYUN_RDS_EMOTIONAL_CHAT_USERNAME', '')}:"
    f"{os.getenv('ALIYUN_RDS_EMOTIONAL_CHAT_PASSWORD', '')}@"
    f"{os.getenv('ALIYUN_RDS_EMOTIONAL_CHAT_HOST', '')}:"
    f"{os.getenv('ALIYUN_RDS_EMOTIONAL_CHAT_PORT', '3306')}/"
    f"{os.getenv('ALIYUN_RDS_EMOTIONAL_CHAT_DATABASE', 'emotional_chat')}"
)
